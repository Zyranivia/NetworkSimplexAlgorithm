...
\path (0, 0) node[circle, draw, text width=0.44cm] (v0) {$3$}
	  (1.5, 1) node[circle, draw] (v1) {}
	  (1.5, 0) node[circle, draw] (v2) {}
	  (3, 0) node[circle, draw, text width=0.44cm] (v3) {$-3$}
	  
	  (6, 0) node[circle, draw, text width=0.44cm] (v4) {$3$}
	  (7.5, 1) node[circle, draw] (v5) {}
	  (7.5, 0) node[circle, draw] (v6) {}
	  (9, 0) node[circle, draw, text width=0.44cm] (v7) {$-3$};

...
\path (0, 0) node[circle, draw, text width=0.44cm] (v0) {$2$}
 	  (3, 0) node[circle, draw, text width=0.44cm] (v1) {$0$}
	  (1.5, 1.5) node[circle, draw, text width=0.44cm] (v2) {$-2$};
...
\path (6, 0) node[circle, draw, text width=0.44cm] (v3) {$2$}
	  (9, 0) node[circle, draw, text width=0.44cm] (v4) {$0$}
	  (7.5, 1.5) node[circle, draw, text width=0.44cm] (v5) {$-2$};
